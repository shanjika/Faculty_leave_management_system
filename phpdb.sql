...
ALTER TABLE `employees` ADD COLUMN IF NOT EXISTS `Gender` varchar(10) NOT NULL DEFAULT 'Male';

-- Add new columns to emp_leaves
ALTER TABLE `emp_leaves`
  ADD COLUMN IF NOT EXISTS `FromSession` varchar(10) DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS `ToSession` varchar(10) DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS `ActivityID` varchar(20) DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS `ActivityName` varchar(200) DEFAULT NULL,
