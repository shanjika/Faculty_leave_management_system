...
<head>
    ...
    <title>Register New Employee - Leave Management</title>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .header-banner h1 { color: #667eea; font-size: 28px; margin-bottom: 5px; }
    ...
    @media (max-width: 768px) {
        ...
        .date-row .form-group { min-width: auto; }
        ...
        <div class="content">
            <div class="container">
                <div class="header-banner">
                    ...
                    <p>Add a new employee to the Leave Management System</p>
                </div>
                ...
                <div class="reg-card">
                    ...
                    <div class="form-subtitle">
                        Fill in all required fields to register a new employee
                    </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="mailid" placeholder="employee@company.com" required>
                                </div>
                                <div class="form-group">
                                    <label>Designation <span class="required">*</span></label>
                                    <input type="text" name="designation" placeholder="Job title" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group" style="margin-top: 20px;">
                                ...
                                <div class="date-row">
                                    ...
                                    <div class="form-group">
                                        <input type="number" name="year-birth" min="1901" max="<?php echo date('Y'); ?>" placeholder="YYYY" required>
                                        <p class="date-label"></p>
                                    </div>
                                </div>
                            </div>
